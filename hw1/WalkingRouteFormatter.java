...
public class WalkingRouteFormatter extends RouteFormatter {
     ...
     **/
  	public String computeLine(GeoFeature geoFeature, double origHeading) {
		...
		line += " onto " + geoFeature.getName() + " and walk for " + time + " minutes.\n";
		return line;
  	}
}
