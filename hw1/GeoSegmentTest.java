...
public class GeoSegmentTest {
	...
	private static final double tolerance = 0.01;
  	...
  	public GeoSegmentTest() {
		gpZivCenter = new GeoPoint(32783098,35014528);
		gpWest = new GeoPoint(32783098,35003854);
		gpEast = new GeoPoint(32783098,35025202);
		gpNorth = new GeoPoint(32792115,35014528);
		
    	gsEast = new GeoSegment("East", gpZivCenter, gpEast);
    	gsWest = new GeoSegment("West", gpZivCenter, gpWest);
    	gsNorth = new GeoSegment("North", gpZivCenter, gpNorth);
    	gsEast2 = new GeoSegment("East", gpWest, gpZivCenter);
    	gsWest2 = new GeoSegment("West", gpWest, gpZivCenter);
	...
	public void show(String str, boolean ok) {
  	...
  	public void test() {
		...
		show("Equal to copy.",
			 gsNorth.equals(new GeoSegment("North", gpZivCenter, gpNorth)));
		...
		show("getP1() & getP2()");
		show("getP1() works.", gsEast.getP1().equals(gpZivCenter));
		show("getP2() works.", gsEast2.getP2().equals(gpZivCenter));
