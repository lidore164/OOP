...
public class ExampleGeoSegments {
	...
	public static final GeoPoint[] points = {
		...
		new GeoPoint(32783098,35014528),	//  1. Ziv Center (Hankin Road, Trumpledor Avenue, Shalom Aleichem & Berl Katznelson Intersection)
		new GeoPoint(32785295,35017833),	//  2. Trumpeldor Avenue & Khanita Intersection
		new GeoPoint(32787081,35020735),	//  3. Trumpeldor Avenue & HaGalil Intersection
		new GeoPoint(32789768,35018578),	//  4. Water Tower (HaGalil & HaBerekha Intersection)
		new GeoPoint(32795631,35010296),	//  5. Hagalil & Hanita Intersection
		new GeoPoint(32786801,35016991),	//  6. Yiga'el Zlatin Square (Khanita & Simha Golan Road Intersection)
		new GeoPoint(32789205,35008467),	//  7. Grand Canyon Shopping Center (on Simha Golan Road)
		new GeoPoint(32790170,35003944),	//  8. Ruppin Interchange (Simha Golan Road & Ruppin Road Intersection)	
		new GeoPoint(32787419,34999041),	//  9. Elisabeth Square (Hankin Road & Ruppin Road Intersection) 	
	...
	public static final GeoSegment[] segments = {
		...
		new GeoSegment("Khanita", 			points[5], points[6]),
		new GeoSegment("Khanita", 			points[6], points[2]),
